...
<body>
	<header>
        ...
        <div class="hSearch">
            <h1 class="logo"><a href="index.do"><img src="/resources/img/mo_logo.png" alt=""></a></h1>
            <div class="search">
       ...
       <nav class="gnb">
           <ul>
               <li><a href="new.do" class="topNav">NEW</a></li>
               <li><a href="best.do" class="topNav">BEST</a></li>
               
               <li><a href="" class="topNav">MAN</a>
                   <ul class="subNav">
                       <li><a href="">상의</a></li>
                       <li><a href="">하의</a></li>
                       <li><a href="">악세서리</a></li>
               ...
               <li><a href="" class="topNav">WOMAN</a>
                   <ul class="subNav">
                       <li><a href="">상의</a></li>
                       <li><a href="">하의</a></li>
                       <li><a href="">악세서리</a></li>
               ...
               <li><a href="" class="topNav">BEAUTY</a>
                   <ul class="subNav">
                       <li><a href="">헤어케어</a></li>
                       <li><a href="">바디케어</a></li>
                       <li><a href="">향수</a></li>
               ...
               <li><a href="sale.do" class="topNav">SALE</a></li>
               <li><a href="magazine.do" class="topNav">MAGAZINE</a></li>
           </ul>
       </nav>
   </header>
