...
create SEQUENCE member_sequence increment by 1 MINVALUE 0;
CREATE TABLE member (
	mb_seq number(10,0),
...
select mb_pw from member where mb_id like '%subin%' and mb_name like '%wef%' and mb_phone like '%010110%';
