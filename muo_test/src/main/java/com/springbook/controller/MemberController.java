...
public class MemberController {
	...
	@GetMapping("/modify")
	public void modify(@ModelAttribute("member")MemberVO member,Model model,@ModelAttribute("cri") Criteria cri) {
		model.addAttribute("member",service.get(member.getMb_seq()));
	}
